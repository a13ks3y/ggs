...
// Обновление shiftVideo.js: добавление экспортируемой функции и обновление логики CLI
...
if (!shiftVideoCode.includes('module.exports = shiftVideo;')) {
    shiftVideoCode = shiftVideoCode.replace('module.exports = shiftVideo;', '');
...
// Обновление cli.js: добавление команд для CLI
