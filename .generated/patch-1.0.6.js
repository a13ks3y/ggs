...
if (!changelogContent.includes('## [1.0.6] - 2024-05-21')) {
...
execSync(`git commit -m "Apply patch-1.0.6.js: ${process.argv.slice(2).join(' ')}"`, { stdio: 'inherit' });
execSync('git push origin master', { stdio: 'inherit' });

// Создание следующего патча и открытие его в редакторе
const nextPatchNumber = 7;
