...
packageJson.scripts['latest-patch'] = "node patch-0.0.15.js";
...
execSync(`git commit -m "Apply patch-0.0.14.js: ${process.argv.slice(2).join(' ')}"`, { stdio: 'inherit' });

// Создание следующего патча и открытие его в редакторе
const nextPatchNumber = 15;
